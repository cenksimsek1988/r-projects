...
# ~ export.gdp + ımport.gdp + lfpr_1564_t + inf + SL.UEM.TOTL.ZS + pre_prim + ter + fdi_r

reg = step(lm(data=dat, real_gdp_cap ~ .), steps = 1000, direction = "both")

reg_last = lm(data = dat, real_gdp_cap ~ exp + imp + lfpr_1564_f + lfpr_15_m + lfpr_1564_m + 
  lfpr_15 + lfpr_1564_t + unemp + pre_prim + ter + prim_gpi + 
  fdi_r)
